...
const Header: React.FC<HeaderProps> = ({
  ...
  const navLinks: { key: string; label: Record<Lang, string> }[] = [
    ...
    {
      key: "programs",
      label: { EN: "Programs", FR: "Programmes", AR: "البرامج" },
    },
    {
      key: "startups",
      label: { EN: "Startups", FR: "Startups", AR: "الشركات" },
    },
    ...
    <header
      style={{
        ...
        borderBottom: scrolled
          ? "1px solid rgba(228,230,239,0.6)"
      ...
      >
        <img
          ...
          style={{
            ...
            display: "block",
            boxShadow: scrolled
              ? "0 4px 16px rgba(27,79,187,0.18)"
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: 2,
            transition:
              "left 0.45s cubic-bezier(0.34, 1.4, 0.5, 1), width 0.45s cubic-bezier(0.34, 1.4, 0.5, 1), opacity 0.25s ease, background 0.25s ease",
            zIndex: 0,
            opacity: 0,
            boxShadow: scrolled
              ? "0 1px 6px rgba(27,79,187,0.35)"
            ...
            >
              <span
                style={{
                  ...
                  transition:
                    "transform 0.35s cubic-bezier(0.34, 1.4, 0.5, 1), color 0.25s ease",
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 32 }}>
            ...
            >
              {{ EN: "Language", FR: "Langue", AR: "اللغة" }[lang]}
            </div>
            <div
              style={{
                display: "grid",
