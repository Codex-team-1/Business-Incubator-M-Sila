...
const TeamSection: React.FC<{ lang: Lang }> = ({ lang }) => {
  const isRTL = lang === 'AR';
  const t = {
    EN: { label: 'The People', title: 'Meet the team behind\nthe incubator.', sub: 'The people guiding M\'Sila\'s founders day to day.' },
    ...
    AR: { label: 'الفريق', title: 'تعرّف على الفريق\nخلف الحاضنة.', sub: 'الأشخاص الذين يرافقون مؤسسي مسيلة يوماً بعد يوم.' },
  }[lang];

  // Brick Yousef photo provided; rest get a styled monogram placeholder until
  ...
  const members: { name: string; photo: string | null; accent: 'blue' | 'green' }[] = [
    ...
    { name: 'Soumia Fodili',       photo: null,                            accent: 'green' },
    ...
    { name: 'Djenaoui Abdellatif', photo: null,                            accent: 'blue'  },
